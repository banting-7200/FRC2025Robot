...
public final class Constants {
  ...
  public final class DriveBase {
    public static final double maxSpeed = Units.feetToMeters(3); // metres per second
    // TODO: why this number?
    public static final double maxAngularVelocity = 1; // radians per second
    public static final double maxCreepSpeed = Units.feetToMeters(3); // metres per second
    public static final double maxMediumSpeed = Units.feetToMeters(3);
    public static final double maxCreepAngularVelocity = 1; // radians per second
    public static final double maxMediumAngularVelocity = 1;
    ...
    public final class TranslationPID {
      public static final double slowP = 0.1;
      public static final double normalP = 0.1;
