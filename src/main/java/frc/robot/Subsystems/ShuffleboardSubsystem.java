...
public class ShuffleboardSubsystem
{
    ...
    /**
     * Sets which layout to put values to.
     * Putting values of the same name in different layouts may mess with code. 
     * 
    ...
    // #region Swerve //
    /**
     * Create a named list layout of swerve motor
    ...
    /**
     * Gets an array of PID values stored under the name 
     * they were originally set with.
     * 
    ...
    /**
     * Creates a button which automatically
     * runs the command it was set with.
     * 
    ...
    /**
     * Creates drop down containing autos, doesn't add any functionality to the
    ...
    /**
     * Gets the status of the arm on the shuffleboard,
     * will return false if entry doesn't exist.
     * @param name The name of the widget
